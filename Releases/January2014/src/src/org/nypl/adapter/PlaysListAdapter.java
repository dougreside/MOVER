...
public class PlaysListAdapter extends BaseExpandableListAdapter{
	...
	public View getChildView(int groupPosition, int childPosition,	boolean isLastChild, View convertView, ViewGroup parent) {
		...
		try {
			bitmap = new FileInputStream(FilePath.getAbsolutePath()+File.separator+CONTENT_LOCATION+File.separator+mPlaysNameList.get(childPosition).getPlayID()+File.separator+mPlaysNameList.get(childPosition).getPlayImage().toString());
